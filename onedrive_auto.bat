...
set "dllPath=%userFolder%\OneDrive - James Cook University\Postgraduate\Python Scripts\conda_dependency_helper\OneDriveLib.dll"
set "scriptPath=%userFolder%\OneDrive - James Cook University\Postgraduate\Python Scripts\conda_dependency_helper"

REM Construct the path dynamically using environment variables
set "userProfilePath=%USERPROFILE%"
set "scriptPath=%userProfilePath%\OneDrive - James Cook University\Postgraduate\Python Scripts\conda_dependency_helper\update_conda_environments.py"
